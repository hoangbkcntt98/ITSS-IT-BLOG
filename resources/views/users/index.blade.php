      ...
      <div class="text-center">
    	...
    	<div class="col-sm-9" style = "padding-top:5%;">
            <ul class="nav nav-tabs">
                ...
                @if($user->is_admin==1)
                <li><a data-toggle="tab" href="#messages">User Manager</a></li>
                <li><a data-toggle="tab" href="#home">Article Manager</a></li>
                @endif
              </ul>
                ...
                {!! Form::open(['action' => ['ProfileController@update',$user->id],'method'=>'PUT','class'=>'form-horizontal','role'=>'form']) !!}
                  <form class="form" action="##" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                           <div class="col-xs-12">
                                <br>
                                {{Form::submit('Save Changes',['class'=>'btn btn-lg btn-success','style'=>'text-align:center;margin-left:40%'])}}
                            </div>
                      </div>
                      {!! Form::close() !!}
...
<!-- <div class="container">
	...
	<div class="row">
      ...
      <div class="col-md-9 personal-info">
        ...
        <h4>Account Type</h4>
            <div class="col-lg-8">
            <h4 class="col-lg-3 control-label">@if($user->is_admin==0)
                    User
